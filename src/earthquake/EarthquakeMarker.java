...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker> {	
	...
	public enum EarthQuakeAge{
		PAST_HOUR, PAST_DAY, PAST_WEEK, PAST_MONTH, UNKNOWN;
	};
	
	protected EarthQuakeAge age;
	...
	public EarthquakeMarker (PointFeature feature) 
	{
		...
		String ageStr = getStringProperty("age");
		this.age = EarthQuakeAge.UNKNOWN;
		if(ageStr != null){
			if ("Past Hour".equals(ageStr))
				this.age = EarthQuakeAge.PAST_HOUR;
			else if ("Past Day".equals(ageStr))
				this.age = EarthQuakeAge.PAST_DAY;
			else if ("Past Week".equals(ageStr))
				this.age = EarthQuakeAge.PAST_WEEK;
			else if ("Past Month".equals(ageStr))
				this.age = EarthQuakeAge.PAST_MONTH;
			else
				this.age = EarthQuakeAge.UNKNOWN;
		}
